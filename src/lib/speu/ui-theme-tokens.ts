...
/** Купальскае зелена — насычаныя зялёныя і залацісты акцэнт. */
const defaultPreset: PresetThemeBundle = {
  light: {
    background: "#F4F6F0",
    foreground: "#152018",
    card: "#FCFDF9",
  ...
  dark: {
    ...
    secondary: "rgba(95, 212, 168, 0.10)",
    secondaryForeground: "#B8E5D0",
    muted: "rgba(255, 255, 255, 0.06)",
    mutedForeground: "#7A9A86",
    accent: "#E8B060",
    accentForeground: "#061008",
    destructive: "oklch(0.65 0.25 27)",
    border: "rgba(95, 212, 168, 0.12)",
    input: "rgba(95, 212, 168, 0.08)",
    ring: "rgba(95, 212, 168, 0.40)",
    sidebar: "#060E0A",
    sidebarForeground: "#D8E8DC",
    sidebarPrimary: "#5FD4A8",
    sidebarPrimaryForeground: "#061008",
    sidebarAccent: "rgba(95, 212, 168, 0.10)",
    sidebarAccentForeground: "#B8E5D0",
    sidebarBorder: "rgba(95, 212, 168, 0.12)",
    sidebarRing: "rgba(95, 212, 168, 0.40)",
    glassBg: "rgba(8, 18, 12, 0.85)",
    glassBorder: "rgba(95, 212, 168, 0.14)",
    glowPrimaryRgb: "95, 212, 168",
    glowAccentRgb: "232, 176, 96",
    selectionBgRgb: "95, 212, 168",
    selectionForeground: "#5FD4A8",
    ornamentStrokeHex: "2B5035",
  },
  topo: {
    dark: {
