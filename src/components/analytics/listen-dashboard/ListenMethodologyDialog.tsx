  ...
  return (
    ...
    >
      ...
      <div className="max-h-[min(70vh,24rem)] overflow-y-auto px-5 py-4 text-sm text-foreground leading-relaxed space-y-3">
        ...
        <p>
          <strong>Што трапляе ў лічбы.</strong> Сесіі запісваюцца толькі для трэкаў, якія ўжо публічна даступныя ў
          каталогу: трэк апублікаваны і мае хаця б аднаго апублікаванага артыста ў крэдытах. Для іншых трэкаў у
          табліцы паказаны бэйдж «без уліку» — праслухоўванні не додаюцца да статыстыкі (уключна з нулямі на
          дашбордзе).
        </p>
        <p>
          <strong>Сервер.</strong> Адмовы запісу (напрыклад, недакладная даўжыня ў метаданых, ліміты) фіксуюцца ў
          логах сервера; у браўзеры можна ўключыць{" "}
          <code className="rounded bg-muted px-1 py-0.5 text-[11px]">NEXT_PUBLIC_SPEU_DEBUG_LISTEN=1</code> для
          папярэджанняў у кансолі пры адмове API.
        </p>
