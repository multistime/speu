...
const PLACEHOLDER_TIERS: Tier[] = [
  ...
  },
  {
    ...
    perks: [
      ...
      "Падзеленыя дарожкі (stems) і файлы праекта",
  ...
  },
  {
    ...
    perks: [
      ...
      "Доля аўтарскіх адлічэнняў на сумесных выданнях",
  ...
  if (status === "loading") {
    return (
      <div className="flex flex-col items-center justify-center gap-4 py-20 md:py-28 text-muted-foreground max-w-5xl mx-auto">
        ...
        <p className="text-sm">Загружаюцца ўзроўні падтрымкі…</p>
      </div>
    );
  }
