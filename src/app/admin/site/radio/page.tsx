    ...
    <div className="space-y-6">
      <div className="glass rounded-2xl border border-border p-6">
        ...
        <p className="text-sm text-muted-foreground">
          Калі ў раздзеле <strong>Песні</strong> лэйбла (<code className="text-xs bg-muted px-1 rounded">/admin/label/songs</code>) ёсць апублікаваныя трэкі з адзнакай «На радыё»,
