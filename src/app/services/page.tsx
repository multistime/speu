...
export const metadata = {
  title: "Паслугі — Спеў",
  description:
    "Замоўце музыку на беларускай мове: ад аўтарскай кампазіцыі да гатовай песні з вашага тэксту. Спеў — беларускі музычны лейбл.",
};
...
const SERVICES_INFO = [
  {
    ...
    color: "#35654D",
    glowRgb: "53, 101, 77",
    features: ["Любы жанр і настроенне", "Вакал на беларускай мове", "Размяшчэнне на стрымінг-пляцоўках"],
  },
  {
    icon: FileText,
    title: "Тэкст у песню",
