...
values
  ...
  ('artists', 'Артысты', 'published', 'Артысты Спеў', 'Каталог беларускіх артыстаў лейбла Спеў'),
  ('support', 'Падтрымка', 'published', 'Падтрымка Спеў', 'Узроўні падтрымкі беларускага музычнага лейбла'),
  ('services', 'Паслугі', 'published', 'Паслугі Спеў', 'Музычныя паслугі і заяўкі')
...
cross join (
  values
    ('home', 'about', 'text', 10, '{"label":"Пра нас","title":"Там, дзе старажытны спеў сустракае новы гук","body":"Спеў — беларускі музычны лейбл. Наша місія простая: каб было больш добрай музыкі на беларускай мове і ў яе было больш слухачоў. Мы ствараем яе самі і дапамагаем іншым рабіць гэта.","subbody":"Беларуская мова можа гучаць у любым жанры — у фолку і электроніцы, у попе і амбіенце. Каранямі мы ў традыцыі: вуснай творчасці, прыродзе, продках. Поглядам — наперад. Слова жыве, пакуль яно гучыць."}'::jsonb),
    ('home', 'generator_cta', 'cta', 20, '{"label":"Наш інструмент","title":"Напішыце тэкст для вашай песні","description":"Генератар Спеў дапамагае ствараць тэксты на беларускай мове: выберыце жанр, настроенне і тэму — і атрымайце гатовую структуру песні за секунды.","button":{"label":"Адкрыць генератар","href":"/generator"}}'::jsonb),
    ('home', 'radio_cta', 'cta', 30, '{"label":"Новае ад Спеў","title":"Радыё Мара","description":"Радыё Мара — наша онлайн-радыёстанцыя, якая кругласутачна круціць беларускі плэйліст у выпадковым парадку. Яе мэта — каб беларуская музыка і беларускае слова гучалі штодня, без цішыні і межаў.","button":{"label":"Слухаць Радыё Мара","href":"/radio"}}'::jsonb),
    ('home', 'support_header', 'text', 40, '{"label":"Падтрымай сцэну","title":"Падтрымай Спеў","description":"Беларуская музыка расце разам з яе супольнасцю. Падтрымай лейбл — і стань часткай таго, як беларуская мова гучыць сёння."}'::jsonb)
...
values
  ('supporter', 'Падтрымальнік', 'Падтрымальнік', 'Музыка на роднай мове жыве дзякуючы вам. Кожны ўклад мае значэнне.', 5, 'USD', '/мес', '["Ранні доступ да новых выданняў","Імя ў альбомных крэдытах","Паштовыя навіны лейбла","Штомесячны дайджэст"]'::jsonb, false, '#35654D', '53, 101, 77', true, 10),
  ('patron', 'Мецэнат', 'Мецэнат', 'Уваходзіце глыбей. Фармуйце тое, што мы ствараем.', 15, 'USD', '/мес', '["Усё ад узроўню Падтрымальнік","Галасаванне за тэмы наступных выданняў","Падзеленыя дарожкі (stems) і файлы праекта","Эксклюзіўныя B-сайды і дэмо","Штомесячная слуханка"]'::jsonb, true, '#C07A30', '192, 122, 48', true, 20),
  ('coproducer', 'Сасупрадзюсар', 'Сасупрадзюсар', 'Станьце часткай лейбла. Ваша імя — на запісе.', 50, 'USD', '/мес', '["Усё ад узроўню Мецэнат","Крэдыт сасупрадзюсара на выданнях","Замова аднаго аўтарскага трэка ў год","Доля аўтарскіх адлічэнняў на сумесных выданнях","Прыватныя сесіі абмеркавання (анлайн)","Уплыў на стратэгію лейбла"]'::jsonb, false, '#7B5EA7', '123, 94, 167', true, 30)
on conflict (code) do nothing;
