...
values
  ('supporter', 'Падтрымальнік', 'Падтрымальнік', 'Музыка на роднай мове жыве дзякуючы вам. Кожны ўклад мае значэнне.', 5, 'USD', '/мес', '["Ранні доступ да новых выданняў","Імя ў альбомных крэдытах","Прыватная рассылка лейбла","Штомесячны дайджэст"]'::jsonb, false, '#35654D', '53, 101, 77', true, 10),
