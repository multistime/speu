-- Прымяніць уручную ў Supabase SQL Editor, калі migration-check паказвае fail па пашырэннях.
-- Файлы-міграцыі: 20260403160000_user_listener_artist_roles.sql + 20260403170000_track_artists_and_user_artist_link.sql
...
grant select on speu.track_artists to anon, authenticated;
grant insert, update, delete on speu.track_artists to authenticated;
